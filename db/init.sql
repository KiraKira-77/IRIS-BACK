...
CREATE TABLE IF NOT EXISTS biz_project_task_work_order (
  ...
  handler_employee_no VARCHAR(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS biz_project_rectification (
  ...
  rectification_oms_work_order_id VARCHAR(100) NULL,
  rectification_oms_status VARCHAR(32) NULL,
  rectification_oms_status_name VARCHAR(100) NULL,
  rectification_work_order_created_at DATETIME NULL,
  rectification_work_order_completed_at DATETIME NULL,
  status VARCHAR(32) NOT NULL,
  remark VARCHAR(500) NULL,
  deleted TINYINT NOT NULL DEFAULT 0,
  version BIGINT NOT NULL DEFAULT 0,
